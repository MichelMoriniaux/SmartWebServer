...
#define AXIS1_ENCODER                 OFF //    OFF, AB, AB_ESP32, CW_CCW, PULSE_DIR, BISS. RA/Azm (A/MA) & (B/SLO.)          Option
...
#define AXIS2_ENCODER                 OFF //    OFF, AB, AB_ESP32, CW_CCW, PULSE_DIR, BISS. Dec/Alt (A/MA) & (B/SLO.)         Option
                                          //         for absolute encoders.
